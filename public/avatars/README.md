...
character concept art --ar 2:3 --style raw --v 7 --sref <TON_CODE_STYLE> --no text, watermark, logo,
...
charcoal studio background, highly detailed character concept art --ar 2:3 --style raw --v 7 --no
...
--style raw --v 7 --no text, watermark, logo, multiple characters, cropped limbs
```
