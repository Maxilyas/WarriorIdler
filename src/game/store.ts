...
import type {
  Equipment, Item, PrimaryStat, OffensiveStat, SecondaryStat, EquipSlotId, ItemType, Enemy, DamageType, RarityId, Character, PowerDef, EnemyAbility,
} from './types'
...
import {
  ...
  setPactDerivedMods, teamTalentPool, talentsSpent, charDeck, isBuilder, isSupport, SUPPORT_SLOTS, type CombatMods as CharCombatMods,
} from './character'
