...
Les **outils horizontaux** de la boucle : taper les paliers (farm) → farmer les **donjons**
...
l'Abîme est gaté palier 100 + `requires` Nexus, calé via `tierOffset`/`anchorStage`.
...
| `tier` | +4 paliers/tier | Courbe **douce et constante** (×~1.9 PV/tier), ~10 tiers atteignables. |
