            ...
            <div key={p.id} className="rounded-lg border border-slate-800 bg-black/20 p-2">
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="flex shrink-0 items-center gap-1 text-[9px]">
                  ...
                  {/* les capacités scalent sur la stat DOMINANTE ; le scaleStat n'est plus qu'une affinité (couleur). */}
                  {p.scaleStat && <span className="rounded px-1 py-0.5 font-bold" style={{ background: SCALE_LABEL[p.scaleStat].color + '33', color: SCALE_LABEL[p.scaleStat].color }} title="Scale sur ta stat primaire DOMINANTE — le type de dégâts reste l'identité de la capacité.">⚡ dominante</span>}
