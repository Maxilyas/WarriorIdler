...
export const UNIQUE_EFFECTS: UniqueEffect[] = [
  ...
  { id: 'u3_givre_implacable', name: 'Givre implacable', role: 'dps', description: 'Le froid qui touche toujours : [froid] +22%.', mods: { intelligence: 40, precision: 35 }, tagMods: [{ tag: 'froid', mult: 0.22 }], active: 'Tes sorts de froid annulent l\'esquive.' },
  ...
  { id: 'u3_precision_glaciale', name: 'Précision glaciale', role: 'dps', description: 'Le coup direct infaillible : [direct] +20%.', mods: { precision: 50, critique: 25 }, tagMods: [{ tag: 'direct', mult: 0.20 }], active: 'Tes frappes directes ne ratent jamais.' },
